...
class GeneratedArtifactService:
    def __init__(
        ...
        *,
        ...
        hydrate_graph_for_codegen: Callable[[dict[str, Any]], tuple[list[Any], list[Any], list[str], dict[str, list[str]]]],
        node_blueprints_for_codegen: Callable[[list[Any], list[str], dict[str, list[str]]], dict[str, dict[str, Any]]],
    ...
    def build_langgraph_artifact(
        ...
        *,
        ...
        nodes, links, execution_order, upstream_node_ids = self._hydrate_graph_for_codegen(graph_json)
